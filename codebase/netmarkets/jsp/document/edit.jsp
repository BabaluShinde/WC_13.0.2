...
<%
    ...
    if(useCheckinEdit){
%>
        <c:set var="buttonList" value="CheckInWizardButtonsNoSave" scope="page"/>
...
<%-- Adding initClassification tag in order to enable the "preview name" link on set classification attribute step --%>
