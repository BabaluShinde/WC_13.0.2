   ...
   <tr valign="top">
      <td align="left" valign="middle">
         <font class=wizardlabel>
            <%=exportFileLabelBlurb%>&nbsp;<%=containerName%>
         </font>
      </td>
   </tr>
   <tr>
      <td align="left" valign="middle">
         <input name="includesubfolders" type="checkbox" value="true"><font class=wizardlabel><%=objectRb.getString(objectResource.INCLUDE_SUBFOLDERS)%></font>
      </td>
   </tr>
   <tr>
      <td align="left" valign="middle">
         <input name="savefullpath" type="checkbox" value="true"><font class=wizardlabel><%=objectRb.getString(objectResource.SAVE_FULL_PATH)%></font>
      </td>
   </tr>
   <tr>
      <td align="left" valign="middle">
         <input name="checkoutondownload" type="checkbox" value="true"><font class=wizardlabel><%=objectRb.getString(objectResource.CHECKOUT_ON_DOWNLOAD)%></font>
      </td>
   </tr>
</table>
