...
public class dataTCGenericDetails {
	...
	String createItemFileName = outputDir + File.separator
		+ "tcGenericItemCreationDetails_" + whatType.toUpperCase()
		+ "_.csv";
	String cadDataSetFileName = outputDir + File.separator
		+ "tcGenericDataSetDetails_" + whatType.toUpperCase() + "_.csv";
	String cadModelDataFileName = outputDir + File.separator
		+ "tcGenericModelDetails_" + whatType.toUpperCase() + "_.csv";

	String cadGenInsDataFileName = outputDir + File.separator
		+ "tcGenericInstanceDetails_" + whatType.toUpperCase()
		+ "_.csv";
	String createInstanceItemFileName = outputDir + File.separator
		+ "tcInstanceItemCreationDetails_" + whatType.toUpperCase()
		+ "_.csv";
	String createInstanceDataSetFileName = outputDir + File.separator
		+ "tcInstanceDataSetCreationDetails_" + whatType.toUpperCase()
		+ "_.csv";
